<%-- 
    ...
    Created on : Oct 16, 2024, 6:39:28 PM
    Author     : Admin
--%>
...
<html>
    ...
    <link rel="stylesheet" href="css/mainTopPage.css">
    ...
    <form action="" method="POST" class="">
        ...
        <div class="container-s navBar">
            <input type="image" src="assets/img/menuNav.png" class="navMenu">

            <div class="icon-nav-page">
                <img src="assets/img/mainPageLogo.png" alt="">
            </div>
        ...
        <div class="container-s body-main-page-1">
            <div class="slide-show">
                <div class="list-items">
                    ...
                    <div class="items">
                        <img src="assets/img/god-of-war.png" alt="">
                        ...
                        <div class="more-infor-items">
                            ...
                            <div class="infor-more">
                                ...
                                <div class="more-infor">
                                    <div class="more-infor-img"><img src="assets/img/heart.png" alt=""></div>
                    ...
                    <div class="items">
                        <img src="assets/img/sekiro.png" alt="">
                    ...
                    <div class="items">
                        <img src="assets/img/elden-ring.png" alt="">
    ...
    <script src="js/mainTopPage.js"></script>
</body>
</html>
